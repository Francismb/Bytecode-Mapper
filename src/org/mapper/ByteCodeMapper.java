...
import org.mapper.io.jar.ClassRetriever;
import org.mapper.io.xml.XMLExporter;
...
import org.mapper.requisite.Resource;
import org.mapper.requisite.Transformer;
import org.mapper.utilities.Utilities;
import org.objectweb.asm.tree.*;
import org.mapper.io.xml.XMLReader;
...
import org.mapper.utilities.data.Action;
 ...
 */
public abstract class ByteCodeMapper {

    /**
     * The action decides how the updater runs.
     * See {@link org.mapper.utilities.data.Action} for the possible actions.
     */
     ...
     */
    public ByteCodeMapper(final Action action, final String patternPath) {
     ...
     */
    public ByteCodeMapper(final Action action, final String patternPath, final boolean generateFrames) {
        this.action = action;
    ...
    /**
     * @return an array of transformers to execute.
     */
    public abstract Transformer[] getTransformers();

    /**
     * @return an array of resourcers to execute.
     */
    public abstract Resource[] getResourcers();

    /**
     * @return a class retriever which retrieves the class files for analysis/updating
     */
    public abstract ClassRetriever getClassRetriever();
    ...
    private void init() {
         ...
         */
        log("\nLoading class files");
        final ClassRetriever retriever = getClassRetriever();
         ...
         */
        final Transformer[] transformers = getTransformers();
         ...
         */
        final Resource[] resources = getResourcers();
        log("\nExecuting " + resources.length + " resource gatherers");
        for (final Resource resourcer : getResourcers()) {
